...
func _spawn_objects() -> void:
	...
	create_object({
		"name": "Mrs Brighta", "action": "Talk", "quality": 3,
		"need": "mental_health", "base_restore": 10.0, "time_cost": 15,
		"alt_action": "Ask for Recommendation", "alt_need": "mental_health", "alt_restore": 15.0, "alt_time": 30,
		"pos": Vector2(17, -12),
	})
